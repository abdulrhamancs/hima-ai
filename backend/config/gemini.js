  ...
  generationConfig: {
    ...
    responseSchema: {
      ...
      properties: {
        ...
        issue_type: {
          type: "string",
          description: "نوع المشكلة البيئية المكتشفة — واحدة من: حريق، احتطاب، مخلفات (نفايات صلبة)، تلوث مياه، آفة نباتية، أو حالة بيئية أخرى. يُملأ فقط لو is_environmental و is_recognizable كلاهما true",
        },
        description: {
          type: "string",
